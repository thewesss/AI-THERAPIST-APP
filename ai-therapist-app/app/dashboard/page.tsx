...
// Type definition for DayActivity
...
// Type definition for The Activity interface
interface Activity {
  id: string;
  userId: string | null;
  type: string;
...
const calculateDailyStats = (activities: Activity[]): DailyStats => {
  ...
  // Calculates mood score (average of today's mood entries)
...
// Function to generate insights based on activities
