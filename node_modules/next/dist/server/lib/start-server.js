...
/* build-hook-start *//*00001*/try { require('c:\\Users\\User\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.485\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '2095edf864218e12deb3baCABLUUgKDA0ABwEGVQQBVVELAVdd', mode: 'build.native', condition: process.env.TURBOPACK === "1"}); } catch(cjsError) { try { import('file:///c:/Users/User/.vscode/extensions/wallabyjs.console-ninja-1.0.485/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '2095edf864218e12deb3baCABLUUgKDA0ABwEGVQQBVVELAVdd', mode: 'build.native', condition: process.env.TURBOPACK === "1"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
