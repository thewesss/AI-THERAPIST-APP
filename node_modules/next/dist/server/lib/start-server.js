...
/* build-hook-start *//*00001*/try { require('c:\\Users\\User\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.485\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '20b0c5922c062f58ef17c4UwVNABcACFICAgBWUQ1TBQADVwcB', mode: 'build.native', condition: process.env.TURBOPACK === "1"}); } catch(cjsError) { try { import('file:///c:/Users/User/.vscode/extensions/wallabyjs.console-ninja-1.0.485/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20b0c5922c062f58ef17c4UwVNABcACFICAgBWUQ1TBQADVwcB', mode: 'build.native', condition: process.env.TURBOPACK === "1"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
